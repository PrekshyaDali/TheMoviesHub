        ...
        <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
            <section className="flex justify-between items-center">
                ...
                <div className="flex justify-center items-center mb-[2rem]">
                    ...
                    >
                        <AiOutlineHome className="mr-2 mt-[3rem] " size={26} color='white' />
                ...
                <div className="flex justify-center items-center mb-[2rem]">
                    <Link
                        ...
                        className="flex items-center transition-transform transform hover:translate-x-2"
                    >
                        <MdOutlineLocalMovies className="mr-2 mt-[3rem] " size={26} color='white' />
                ...
                <div>
                    ...
                    {dropdownOpen && userInfo && (
                        <ul
                            className={`absolute right-0 mt-2 mr-14 w-[10rem] space-y-2 bg-white text-gray-600 ${!userInfo.isAdmin ? "-top-20" : "-top-24"
                                }`}
                        >
                            {userInfo.isAdmin && (
                                <>
